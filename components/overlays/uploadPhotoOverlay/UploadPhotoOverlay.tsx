      ...
      <form>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex flex-col items-center gap-1'>
            ...
            <input type='text' className='w-full md:w-4/5 p-2 bg-white/50 dark:bg-white/10 text-sm rounded-md placeholder:text-black/70 dark:placeholder:text-white/70' placeholder='description #hashtag #hashtag2' />
