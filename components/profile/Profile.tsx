...
const Profile = () => (
  <div className='flex flex-col items-center mb-16'>
    <h1 className='text-4xl mt-20 mb-4 text-end mx-4 sm:mx-12 md:mx-20'>profile</h1>
    ...
    <h3 className='text-sm text-black dark:text-white mb-2 cursor-pointer'>@lukyno</h3>
  </div>
);
