const LikesModal = () => (
  <div className='group-hover:flex hidden absolute h-80 w-80 justify-center rounded-md right-1/2 translate-x-1/2 bottom-1/2 mr-16 sm:mr-0 bg-white/90 dark:bg-black/90 mb-10 gap-8'>
    <div className='flex flex-col px-4 py-4 gap-4 text-left overflow-scroll'>
